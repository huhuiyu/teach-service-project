...
public class LinkInfoController {
  ...
  @AnnoNoToken
  @ApiOperation(value = "区域信息多级联动查询", notes = "不需要token信息")
  ...
  @AnnoNoToken
  @ApiOperation(value = "查询省份信息", notes = "不需要token信息")
  ...
  @AnnoNoToken
  @ApiOperation(value = "查询省份对应的城市信息", notes = "不需要token信息")
  ...
  @AnnoNoToken
  @ApiOperation(value = "查询部门对应的员工信息", notes = "不需要token信息")
  ...
  @AnnoNoToken
  @ApiOperation(value = "查询班级信息", notes = "不需要token信息")
  ...
  @AnnoNoToken
  @ApiOperation(value = "查询班级对应的学生信息", notes = "不需要token信息")
